...
cfbc = CFBasicCos(udict, mdict)

rpath = 'data/results'
res5 = cfbc.cf(test5)
res5.to_csv(os.path.join(rpath, 'result5_cf_bas_cos.txt'), index=None, header=None, sep=' ')
res10 = cfbc.cf(test10)
res10.to_csv(os.path.join(rpath, 'result10_cf_bas_cos.txt'), index=None, header=None, sep=' ')
res20 = cfbc.cf(test20)
res20.to_csv(os.path.join(rpath, 'result20_cf_bas_cos.txt'), index=None, header=None, sep=' ')