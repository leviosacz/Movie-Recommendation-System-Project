...
class BipolarSlopeOne:
    ...
    def cal_rate(self, mid, uinfo):
        ...
        for knownmid in uinfo['rated']:
            ...
            if knownmid in self.mdict[mid]['dev']['like']:
                devs.append(self.mdict[mid]['dev']['like'][knownmid])
                cards.append(self.mdict[mid]['dev_len']['like'][knownmid])
                rates.append(uinfo['rated'][knownmid])

            if knownmid in self.mdict[mid]['dev']['dislike']:
                devs.append(self.mdict[mid]['dev']['dislike'][knownmid])
                cards.append(self.mdict[mid]['dev_len']['dislike'][knownmid])
                rates.append(uinfo['rated'][knownmid])
