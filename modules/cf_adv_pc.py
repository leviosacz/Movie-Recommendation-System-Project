...
class CFAdvPC:
    ...
    def cf(self, testdata: dict, round_=True, k=60, sim=0.2):
        res = []
    ...
    def cal_weight(self, trainuinfo, testuinfo):
        ...
        for mid in intersect:
            trainrate.append(self.mdict[mid]['IUF'] * (trainuinfo['rated'][mid] - trainuinfo['avg']))
            testrate.append(self.mdict[mid]['IUF'] * (testuinfo['rated'][mid] - testuinfo['avg']))
        ...
        weight *= math.pow(abs(weight), self.ca_power - 1)
        return weight
